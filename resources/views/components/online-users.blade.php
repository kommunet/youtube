                    ...
                    <td width="170">
                        <div style="padding: 2px 5px 10px 5px;">
                            ...
                            @foreach($users as $user)
								...
								<div style="font-size: 12px; margin-bottom: 8px; padding-bottom: 10px; border-bottom: 1px dashed #CCCC66;"><a href="#"><img src="/img/icon_vid.gif" alt="Videos" width="14" height="14" border="0" style="vertical-align: text-bottom; padding-left: 2px; padding-right: 1px;"></a> (<a href="#">0</a>)
