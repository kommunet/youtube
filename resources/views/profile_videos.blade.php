		...
		<div style="padding-bottom: 15px;">
			<table align="center" cellpadding="0" cellspacing="0" border="0">
				<tbody>
					<tr>
						<td>
							<a href="{{ route('profile', ['user' => $user->username]) }}">Profile</strong>
						</td>
						<td style="padding: 0px 5px 0px 5px;">|</td>
						<td>
							<strong>Public Videos</strong> ({{ $user->num_public_videos }})
						</td>
						<td style="padding: 0px 5px 0px 5px;">|</td>
						<td>
						...
						<table width="100%" align="center" cellpadding="0" cellspacing="0" border="0" bgcolor="#CCCCCC">
							<tbody>
								...
								<tr>
									...
									<td>
										{{-- Title bar --}}
										<x-modules.title-bar title="Public Videos // {{ $user->username }}">
										...
										<x-modules.video-entries :videos="$videos" type="v" trim="true" fulldates="true"/>
